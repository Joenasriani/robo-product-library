...
- Status: ready
- Priority: high
- Folder: systems/agents/tender_analyzer_gcc_product
- Port: 8000
...
- Status: ready
- Priority: high
- Folder: systems/agents/sales_outreach_agent
- Port: 8001
...
- Status: ready
- Priority: high
- Folder: systems/agents/lead_research_agent
- Port: 8002
...
- Status: ready
- Priority: high
- Folder: systems/agents/enterprise_rfp_response_assistant
- Port: 8003
...
- Status: ready
- Priority: high
- Folder: systems/agents/social_content_ops_agent
- Port: 8004
...
- Status: ready
- Priority: medium
- Folder: systems/agents/robot_demo_video_generator
- Port: 8005
...
- Status: ready
- Priority: medium
- Folder: systems/agents/claw_hub_installer_agent
- Port: 8006
...
- Status: ready
- Priority: medium
- Folder: systems/agents/tender_monitoring_agent
- Port: 8007
...
- Priority: high
- Folder: systems/agents/ai_agent_download_center
- Port: 8008
...
- Commercial: non_commercial (internal marketplace infrastructure)
- Priority: very_high
- Folder: systems/agents/protocol_marketplace_agent
- Port: 8009
...
- Status: ready
- Priority: high
- Folder: plans/gcc_localization_packs
- Countries:
  - uae
  - saudi
  - qatar
...
Next priorities:
1. Wire Protocol Marketplace Agent to actual deliverable files in products/downloadables/
2. Wire AI Agent Download Center to actual deliverable files in products/ai/
...
- Status: ready
- Priority: high
- Folder: systems/rag/simple-rag-chain
- Port: 8501 (Streamlit)
...
- Status: ready
- Priority: high
- Folder: systems/rag/tool-use-rag
- Port: 8502 (Streamlit)
...
- Status: ready
- Priority: high
- Folder: systems/rag/rag-as-a-service
- Port: 8000 (FastAPI)
...
- Status: ready
- Priority: medium
- Folder: systems/rag/advanced-rag
- Port: 8504 (Streamlit)
