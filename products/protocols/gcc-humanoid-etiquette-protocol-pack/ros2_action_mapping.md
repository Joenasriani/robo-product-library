...
This file maps the GCC Humanoid Etiquette Protocol Pack to ROS 2-compatible actions and services. It is an integration reference for robotics developers, not a claim that every robot exposes these exact interfaces out of the box.
