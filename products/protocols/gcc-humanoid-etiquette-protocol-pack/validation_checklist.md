...
- [ ] Product has a manifest with buyer, use case, deliverables, limitations, status, and sales mode.
- [ ] Product does not claim certification, legal approval, religious authority, or guaranteed deployment compatibility.
- [ ] Product has a structured protocol file that robotics developers can review.
...
This product can be listed as an inquiry-led downloadable protocol pack only if the listing clearly states that it is a structured implementation reference and not a turnkey certified robot safety system.
